...
const assets=['index.html','theme.js','core.js','journal.js','catalogue.js','app.js','styles.css','export.js','about.js'];
...
console.log('Wholehearted '+version+': '+(assets.length+1)+' browser assets.');
if(process.env.VERCEL_ENV==='preview')require('./source-probe.cjs');
